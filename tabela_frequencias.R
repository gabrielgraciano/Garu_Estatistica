tabela_frequencias <-
  tabItem(tabName = 'tabela_frequencias',
          sidebarLayout(
            sidebarPanel(
      ...
      isso é através da tabela de frequências."),
              HTML("<p>A <strong>frequência absoluta</strong> é o número de observações correspondente a cada categoria. Outra medida bastante útil em tabelas de 
         frequência é a <strong>proporção</strong> de cada realização em relação ao total. Esta se dá dividindo a frequência absoluta de cada categoria 
         pelo número total de ocorrências.</p>"),
